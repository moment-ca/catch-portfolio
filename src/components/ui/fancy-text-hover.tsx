...
const DefaultLinks: FancyLinkItem[] = [
  { label: 'Time-is-broken', href: '#home' },
]
    ...
    >
      {links.map((link) => (
        <a
          ...
          className=' text-white text-3xl font-medium uppercase no-underline transition duration-250 ease-[cubic-bezier(0.76,0,0.24,1)]'
        >
          {link.label}
        </a>
      ))}
