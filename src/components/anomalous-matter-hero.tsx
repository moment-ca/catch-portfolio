...
export function AnomalousMatterHero({
  ...
  subtitle = "A better system for time.",
  description = "Catch brings people, businesses, and autonomous systems into one shared timeline, so the right things happen at the right moment.",
}) {
  return (
    <section
      role="banner"
    ...
    >
      ...
      <div className="relative z-20 flex flex-col items-center justify-end h-full pb-20 md:pb-32 text-center">
        <div className="max-w-3xl px-4 animate-fade-in-long">
          ...
          <p className="mt-6 max-w-xl mx-auto text-base leading-relaxed text-white">
            {description}
          </p>
        </div>
      </div>
