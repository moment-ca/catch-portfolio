...
const highlightPills = [
  ...
  "humans x agents x businesses",
  "zero conflicts, just possibilities",
] as const;
...
export function GlowyWavesHero() {
  ...
  return (
    <section
      className="relative isolate flex w-full items-center justify-center overflow-hidden bg-black py-24"
      role="region"
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center px-6 py-10 text-center md:px-8 lg:px-12">
        <motion.div
        ...
        >
          {/* <motion.div
            ...
            className="mb-6 inline-flex items-center gap-2 rounded-sm border border-border/40 bg-zinc-900 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-white/80"
          >
            <Sparkles className="h-4 w-4 text-primary" aria-hidden="true" />
            smart scheduling for the real world
          </motion.div> */}
          ...
          >
            One shared timeline{" "}
            <span className="text-muted-foreground bg-clip-text">
          ...
          >
            Catch unifies availability across people, businesses, and systems by connecting the calendars and scheduling sources they already use. The result is one reliable view of what can happen, and when.
          </motion.p>
          ...
          >
            ...
            <Button
              size="lg"
              variant="outline"
              className="rounded-full border-border/40 bg-background/60 px-8 text-base text-white/80 backdrop-blur transition-all hover:border-border/60 hover:bg-background/70"
            >
              Explore stories
            </Button>
          </motion.div> */}
          ...
          >
            {highlightPills.map((pill) => (
              <li
                key={pill}
                className="rounded-sm border border-border/40 bg-zinc-900 px-4 py-2 backdrop-blur dark:border-border/60 dark:bg-zinc-900"
              >
                {pill}
              </li>
            ))}
